...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO diary_entries (user_id, title, content, mood_status, entry_date) 
                VALUES (?, ?, ?, ?, ?)";

        $stmt = mysqli_prepare($con, $sql);
        mysqli_stmt_bind_param($stmt, "issss", $user_id, $title, $content, $mood_status, $entry_date);
...
<div class="container">
    ...
    <p class="small-text">Write down what happened today and how you felt about it.</p>
    ...
    <!-- Form Section -->
    <form action="add_diary.php" method="POST" id="entryForm">
        <div class="entry-layout">
            ...
            <div class="entry-main">
                ...
                <div class="field" style="margin-bottom: 20px;">
                    ...
                    <textarea id="content" name="content" style="width: 100%; box-sizing: border-box; min-height: 150px; resize: vertical;"
                            placeholder="What's on your mind today?" required><?php
            ...
            <aside class="entry-sidebar">
                <div class="card">
                        ...
                        <select id="mood_status" name="mood_status" required>
                            <?php foreach ($moods as $mood): ?>
                                <option value="<?php echo htmlspecialchars($mood); ?>"
                                    <?php echo (isset($_POST['mood_status']) && $_POST['mood_status'] === $mood) ? 'selected' : ''; ?>>
                    ...
                    <button type="submit" style="margin-top: 20px;">Save Entry</button>
                </div>
            </aside>
